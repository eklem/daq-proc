...
const html = require('./test-data.js') // Example grabbed from https://en.wikipedia.org/wiki/September_2019_climate_strikes
...
test('extract arrays from strings, remove stopwords, make ngrams, find keywords ', function (t) {
  ...
  const bodyNgrams = ngraminator(bodyStopped, [2, 3, 4])
